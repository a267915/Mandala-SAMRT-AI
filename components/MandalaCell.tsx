  ...
  return (
    <div 
      ...
      className={`
        ...
        ${isCenter ? 'bg-indigo-600 text-white shadow-lg z-10' : 'bg-white text-gray-800 hover:bg-gray-50'}
        ${isActive ? 'ring-2 md:ring-4 ring-indigo-300 z-20' : 'border-gray-200'}
        ${highlight ? 'ring-2 ring-yellow-400 bg-yellow-50' : ''}
      `}
    >
      {/* Background Media */}
      ...
      <div className="relative z-10 w-full h-full flex items-center justify-center">
        {isCenter ? (
            ...
            <textarea
                ...
                placeholder="..."
                className={`
                    bg-transparent text-gray-800 text-center font-medium 
      ...
      <div className="absolute top-0.5 right-0.5 md:top-1 md:right-1 flex space-x-0.5 md:space-x-1">
        ...
        {data.imageUrl && <Image size={12} className={`md:w-4 md:h-4 ${isCenter ? "text-indigo-200" : "text-gray-400"}`} />}
